...
#                 nn.init.kaiming_uniform_(m.weight) pytorch
...
class MLCA_NN:
    ...
    def fit(self, epochs, batch_size, X_valid=None, Y_valid=None):
        ...
        # pdb.set_trace()
        # if self.X_train.device and self.Y_train
        ...
        for n in range(epochs):
            ...
            #avg error of last epoch is appended
            ...
            if (self.X_valid is not None) and (self.Y_valid is not None):
                #on eval mode there is ne dropout
                self.model.eval()
                Xval = self.X_valid
                Yval = self.Y_valid
...
#         return (loss)
        ...
        #burada butun listeyi cekebilirsin
